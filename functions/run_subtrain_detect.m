function Detections=run_subtrain_detect(roi,F_weights,Buffer_length,test,F_ds,All_objs,snr_lim)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    while(1)               
        ...
        mode=0;
        if length(locs)>2
            Detected_subtrains=subtrain_detect(ref_ToAs,F_weights,locs,buffer,F_ds,All_objs,mode); 
